          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center justify-between">
                ...
                <button onClick={handleToggleWishlist} className={`p-2 rounded-full ${isWishlisted ? 'bg-red-100 dark:bg-red-900/30' : 'bg-gray-100 dark:bg-gray-800'}`} aria-label={isWishlisted ? 'Remove from wishlist' : 'Add to wishlist'}>
                  <HeartIcon className={`h-6 w-6 ${isWishlisted ? 'text-red-500 fill-red-500' : 'text-gray-500 dark:text-gray-400'}`} />
                </button>
              </div>
